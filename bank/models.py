...
class Deposit (models.Model):
    ...
    notification_message = models.CharField (max_length = 200, default = "Dear Sir, Your wire transfer request has been approved. Your account has been debited by $1,010.00 on 29/08/2023 08:25",)
